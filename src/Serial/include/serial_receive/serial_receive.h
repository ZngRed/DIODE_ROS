...
#include </home/dhu/RM_ROS_ws/devel/include/rm_msgs/serial_receiver.h>
...
class c_board
{
    public:
		...
		float speed; // 弹速
        int mode;
        float process_float_data[255];
        unsigned char rdata[255];

		bool Get_serial_Data();
		void pub_serial_receiver();

    private:
        ros::NodeHandle n; //创建ROS节点句柄
        ros::Publisher serial_receicer_pub;
